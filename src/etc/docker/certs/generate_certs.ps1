...
# $prokectsServiceCert = New-SelfSignedCertificate -DnsName $projectsServiceCNs -Signer $rootCN -CertStoreLocation Cert:\LocalMachine\My
# $saasServiceCert = New-SelfSignedCertificate -DnsName $saasServiceCNs -Signer $rootCN -CertStoreLocation Cert:\LocalMachine\My
